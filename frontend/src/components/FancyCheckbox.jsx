export default function FancyCheckbox({ checked, onChange, label, id }) {
  return (
    <label htmlFor={id} className="group relative inline-flex cursor-pointer items-center gap-2 rounded-xl border border-[#e7e0f0] bg-white px-3 py-2 text-sm text-[#1f2937] transition hover:border-[#765492]/45 hover:shadow-sm">
      <input
        id={id}
        type="checkbox"
        checked={checked}
